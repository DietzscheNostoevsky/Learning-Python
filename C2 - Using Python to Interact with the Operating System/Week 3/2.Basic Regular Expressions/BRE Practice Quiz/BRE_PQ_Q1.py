...
if the text passed qualifies as a top-level web 
address, meaning that it contains alphanumeric characters
...
using escape characters, wildcards, 
repetition qualifiers, beginning and end-of-line 
