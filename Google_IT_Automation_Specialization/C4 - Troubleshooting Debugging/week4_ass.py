...
def get_same_or_newer(start_date, empdata):
...
def list_newer(start_date):
    empdata = preprocesseddata()

    while start_date < datetime.datetime.today():
        start_date, employees = get_same_or_newer(start_date, empdata)
        # change function call , now its passing employee data too
