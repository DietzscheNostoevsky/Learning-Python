...
def process_data(data):
  ...
  """
    ...
    for item in data:
        ...
        sales_by_year[item_year] = sales_by_year.setdefault(
            item_year, 0) + item_sales

    # set most popular year and amount:
    most_popular_year = sorted(
        sales_by_year, key=sales_by_year.get, reverse=True)[0]
