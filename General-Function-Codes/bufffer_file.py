...
file = "/Users/saurabhkumarsingh/Documents/GitHub/Dataset/Russian_literature_EN/Dostoevsky/TBK.txt"
...
def FrequencyWithUninterestingRemoved(listofwords):
    ...
    uninteresting_words = ["the", "a", "to", "if", "is", "it", "of",
                           ...
                           'having', '"', "'", '"i', '”', "’", '“i',                           'he', "he'd", "he'll", "he's", 'her', 'here', "here's",
...
def printformat(indict):
    for word, num in indict.items():
        if num > 100:
            ...
            #print("{} : {}".format(word, str(num)))
            #print("{:<6s} : {:>6s}".format(word, str(num)))
